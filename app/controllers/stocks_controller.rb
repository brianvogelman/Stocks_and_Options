class StocksController < ApplicationController
	...
	def show
		...
		@option_strike = Unirest.get("https://sandbox.tradier.com/v1/markets/options/strikes?symbol=#{@stock_symbol}&expiration=#{@option_expiration}", headers:{"Accept" => "application/json", "Authorization" => "Bearer qAUHez0or2BAlrF7d4AsGlzn1hbv"}).body['strikes']['strike'][0]
